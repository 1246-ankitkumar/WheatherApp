...
<div className="current-cart3">
  ...
  <div className="cart">
    ...
    <h9>{data.hour[0].condition.text}</h9>
    <h54>{data.hour[0].
temp_c
} C</h54>
  ...
  <div className="cart">
    ...
    <h9>{data.hour[1].condition.text}</h9>
    <h54>{data.hour[1].
temp_c
} C</h54>
  </div>
  ...
  <div className="cart">
    ...
    <h9>{data.hour[2].condition.text}</h9>
    <h54>{data.hour[2].
temp_c
} C</h54>
  </div>
  <div className="cart">
    ...
    <h9>{data.hour[3].condition.text}</h9>
    <h54>{data.hour[3].
temp_c
} C</h54>
  </div>
  <div className="cart">
    ...
    <h9>{data.hour[4].condition.text}</h9>
    <h54>{data.hour[4].
temp_c
} C</h54>
  </div>
  <div className="cart">
    ...
    <h9>{data.hour[5].condition.text}</h9>
    <h54>{data.hour[5].
temp_c
} C</h54>
  </div>
  <div className="cart">
    ...
    <h9>{data.hour[6].condition.text}</h9>
    <h54>{data.hour[6].
temp_c
} C</h54>
  ...
  <div className="cart">
    ...
    <h9>{data.hour[7].condition.text}</h9>
    <h54>{data.hour[7].
temp_c
} C</h54>
